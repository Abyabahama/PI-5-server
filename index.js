...
app.post('/aplicador/pj/cadastro', (req, res) => {
  ...
  const sql = `INSERT INTO aplicador_PJ (RG, Nome, Nacionalidade, EstCivil, Profissao, CPF, Email, Endereco, Cidade, Telefone, UF, Curriculo, URL, Linkedin, Portfolio, Lattes, Valor, Empresa, CNPJ, CNAE, NomeResponsavel, EmailResponsavel, CPFResponsavel) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`
